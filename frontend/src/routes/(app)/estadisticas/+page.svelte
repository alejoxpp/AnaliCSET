...
<div class="animate-fade-in-up space-y-6">
	...
	<div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between print:mb-4">
		<div>
			<div class="flex items-center gap-2">
				<span class="inline-flex items-center gap-1 rounded-md bg-primary-100 px-2.5 py-0.5 text-xs font-semibold text-primary-800 dark:bg-primary-500/20 dark:text-primary-300">
					SENA · CSET
				</span>
				<span class="text-xs text-neutral-500 dark:text-neutral-400">Comité de Evaluación y Seguimiento</span>
			</div>
			<h2 class="font-heading text-xl font-bold tracking-tight text-neutral-900 sm:text-2xl mt-1 dark:text-neutral-50">
		...
		<div class="flex flex-wrap items-center gap-2 print:hidden">
			<button
				type="button"
				onclick={exportarCSV}
				class="inline-flex items-center gap-1.5 rounded-lg border border-neutral-300 bg-white px-3 py-2 text-xs font-semibold text-neutral-700 shadow-xs transition-colors hover:bg-neutral-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 cursor-pointer dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-200 dark:hover:bg-neutral-800/50"
			...
			<PrintButton label="Generar reporte" />
		</div>
	</div>
	...
	<Card class="print:hidden">
		<div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
			...
			<div class="flex flex-col gap-1.5">
				<span class="text-xs font-semibold tracking-wide text-neutral-600 uppercase dark:text-neutral-300">
					Periodo de análisis
				</span>
				<div
					class="inline-flex flex-wrap items-center gap-1 rounded-lg border border-neutral-200 bg-neutral-100 p-1 dark:border-neutral-800 dark:bg-neutral-800"
					role="group"
					...
					{#each ['ultimoMes', 'ultimoTrimestre', 'ultimoSemestre', 'anioCompleto'] as key}
						<button
							...
							class="rounded-md px-3 py-1.5 text-xs font-semibold transition-all cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500
								...
								: 'text-neutral-700 hover:bg-white hover:text-neutral-900 dark:text-neutral-300 dark:hover:text-white'} dark:hover:bg-neutral-900"
						>
							{rangoLabels[key]}
						</button>
					{/each}
			...
			>
				<div>
					<label for="fecha-desde" class="block text-xs font-medium text-neutral-700 mb-1 dark:text-neutral-200">
						Desde
					</label>
					<input
						id="fecha-desde"
						...
						class="rounded-md border border-neutral-300 bg-white px-2.5 py-1.5 text-xs text-neutral-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-50"
					/>
				</div>

				<div>
					<label for="fecha-hasta" class="block text-xs font-medium text-neutral-700 mb-1 dark:text-neutral-200">
						Hasta
					</label>
					<input
						id="fecha-hasta"
		...
		<div class="mt-3 flex items-center justify-between border-t border-neutral-100 pt-3 text-xs text-neutral-500 dark:border-neutral-800 dark:text-neutral-400">
			<p>
				Mostrando datos del intervalo:
				<strong class="font-semibold text-neutral-800 dark:text-neutral-100">{stats.desde}</strong> al
				<strong class="font-semibold text-neutral-800 dark:text-neutral-100">{stats.hasta}</strong>
				({rangoLabels[rangoSeleccionado]})
			</p>
			{#if cargando}
				<span class="inline-flex items-center gap-1 font-medium text-primary-600 dark:text-primary-400">
	...
	<div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
		<div class="rounded-lg border border-neutral-200 bg-white p-4 shadow-xs dark:border-neutral-800 dark:bg-neutral-900">
			<p class="text-xs font-medium text-neutral-500 dark:text-neutral-400">Casos en periodo</p>
			<p class="mt-1 font-heading text-2xl font-bold text-neutral-900 dark:text-neutral-50">{stats.totalCasos}</p>
			<span class="mt-1 inline-flex text-[11px] font-medium text-success-600 dark:text-success-500">↓ 19.4% vs periodo ant.</span>
		</div>
		<div class="rounded-lg border border-neutral-200 bg-white p-4 shadow-xs dark:border-neutral-800 dark:bg-neutral-900">
			<p class="text-xs font-medium text-neutral-500 dark:text-neutral-400">Causa principal</p>
			<p class="mt-1 font-heading text-xl font-bold text-primary-900 dark:text-neutral-50">Inasistencia</p>
			<span class="mt-1 text-[11px] text-neutral-500 dark:text-neutral-400">31% del volumen total</span>
		</div>
		<div class="rounded-lg border border-neutral-200 bg-white p-4 shadow-xs dark:border-neutral-800 dark:bg-neutral-900">
			<p class="text-xs font-medium text-neutral-500 dark:text-neutral-400">Patrón IA crítico</p>
			<p class="mt-1 font-heading text-xl font-bold text-accent-700 dark:text-accent-400">Reincidencia</p>
			<span class="mt-1 text-[11px] text-accent-600 font-medium dark:text-accent-400">Detectado en 28 fichas</span>
		</div>
		<div class="rounded-lg border border-neutral-200 bg-white p-4 shadow-xs dark:border-neutral-800 dark:bg-neutral-900">
			<p class="text-xs font-medium text-neutral-500 dark:text-neutral-400">Acuerdos efectivos</p>
			<p class="mt-1 font-heading text-2xl font-bold text-neutral-900 dark:text-neutral-50">84.2%</p>
			<span class="mt-1 text-[11px] text-success-600 font-medium dark:text-success-500">Cumplimiento positivo</span>
		</div>
	</div>
				...
				<Card title="Distribución de casos por tipo">
					{#snippet footer()}
						<div class="flex items-center justify-between text-xs text-neutral-500 dark:text-neutral-400">
							...
							<span class="font-medium text-neutral-700 dark:text-neutral-200">Total: {stats.totalCasos} casos</span>
						</div>
					{/snippet}
					<div class="h-80">
						<ChartWrapper
	...
	{:else}
		<div class="animate-fade-in-up" style="animation-delay: 180ms;">
			<Card title="Comparativa evolutiva de casos">
				{#snippet footer()}
					<div class="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between text-xs text-neutral-500 dark:text-neutral-400">
						<p>
							Curva continua: <strong class="text-primary-700 dark:text-primary-400">Periodo actual</strong> | Línea segmentada: <strong class="text-neutral-600 dark:text-neutral-300">Periodo anterior</strong>.
						</p>
						<span class="font-medium text-neutral-600 dark:text-neutral-300">{rangoLabels[rangoSeleccionado]}</span>
					</div>
				{/snippet}
				<div class="h-72">
					<ChartWrapper
	...
	<div class="border-t border-neutral-200 pt-6 dark:border-neutral-800">
		<div class="mb-4 flex items-center justify-between">
			<div>
				<div class="flex items-center gap-2">
					<h3 class="font-heading text-lg font-bold text-neutral-900 dark:text-neutral-50">
						Comparativa Interanual (Año a Año)
					</h3>
					<span class="rounded-full bg-primary-100 px-2 py-0.5 text-[10px] font-semibold text-primary-800 dark:bg-primary-500/20 dark:text-primary-300">
						2025 vs 2026
					</span>
				</div>
				<p class="text-xs text-neutral-500 dark:text-neutral-400">
					Evolución interanual por motivo de comité. Variación general:
					<strong class="text-success-600 font-semibold dark:text-success-500">{comparativaAnual.variacionGlobalPct}%</strong>
				</p>
			</div>
		</div>
		...
		<div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
			...
			<Card title="Variación relativa (Δ%)">
				<ul class="divide-y divide-neutral-100 text-sm dark:divide-neutral-800">
					{#each comparativaAnual.categorias as cat, i}
						...
						<li class="flex items-center justify-between py-2.5">
							<span class="text-neutral-700 font-medium dark:text-neutral-200">{cat}</span>
							<div class="flex items-center gap-2">
				...
				{#snippet footer()}
					<p class="text-xs text-neutral-500 text-center dark:text-neutral-400">
	...
	<div class="border-t border-neutral-200 pt-6 dark:border-neutral-800">
		<Card class="border-accent-200/80 bg-gradient-to-br from-white via-white to-accent-50/30 dark:border-accent-700/40">
			<!-- Header del modelo IA -->
			<div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border-b border-neutral-200 pb-4 dark:border-neutral-800">
				<div class="flex items-start gap-3">
					<div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-accent-500/15 text-accent-600 shadow-xs dark:text-accent-400">
					...
					<div>
						<div class="flex items-center gap-2">
							...
							<span class="rounded-full bg-accent-500/20 px-2 py-0.5 text-[10px] font-semibold text-accent-700 dark:text-accent-400">
								Beta / Calibración
							</span>
						</div>
			...
			<div class="grid grid-cols-1 gap-6 pt-4 lg:grid-cols-2">
				...
				<div>
					<p class="text-xs font-semibold text-neutral-700 mb-2 dark:text-neutral-200">
				...
				<div class="space-y-3">
					...
					{#each prediccionIA.insightsIA as insight}
						<div class="rounded-lg border border-neutral-200/80 bg-white p-3.5 shadow-2xs dark:border-neutral-800 dark:bg-neutral-900">
							<div class="flex items-center justify-between">
								<span class="font-heading text-xs font-bold text-neutral-900 flex items-center gap-1.5 dark:text-neutral-50">
							...
							<p class="mt-1 text-xs text-neutral-600 leading-relaxed dark:text-neutral-300">
								{insight.descripcion}
							</p>
							<div class="mt-2 rounded bg-neutral-50 p-2 text-[11px] text-neutral-700 border-l-2 border-primary-500 dark:bg-neutral-800/50 dark:text-neutral-200">
