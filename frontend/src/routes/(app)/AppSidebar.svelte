...
<aside class="flex w-60 shrink-0 flex-col bg-primary-900 text-white">
	<!-- Logo -->
	<a href="/dashboard" class="flex items-center gap-3 px-5 py-5 transition-opacity hover:opacity-90">
		<div
		...
		<div>
			<p class="font-heading text-base font-bold leading-tight tracking-tight text-white">AnaliCSET</p>
			<p class="text-[10px] font-medium tracking-wide text-primary-200">SENA · CSET</p>
		</div>
	</a>
	...
	<div class="border-t border-primary-700/50 px-5 py-3">
		<p class="text-[10px] text-primary-400">AnaliCSET v0.1.0 · MVP</p>
	</div>
</aside>
